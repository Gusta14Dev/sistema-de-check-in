            ...
            <div class="md:col-span-2 xl:col-span-3 bg-white p-6 rounded-2xl border border-gray-50">
                <div class="flex flex-col space-y-6 md:h-full md:justify-between">
                    ...
                    <div class="flex gap-2 md:gap-4">
                        <a href="{{route('rooms')}}" class="bg-blue-600 px-5 py-3 w-full text-center md:w-auto rounded-lg text-white text-xs tracking-wider font-semibold hover:bg-blue-800">
                            Ver todas as aulas
                        </a>
                    </div>
                </div>
